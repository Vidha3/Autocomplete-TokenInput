...
var DEFAULT_SETTINGS = {
	// Search settings
    // http://www.omdbapi.com/?&apikey=b56732e1&s=home*
    method: "GET",
    contentType: "json",
    queryParam: "s",
    titleQueryParam: "t",
    ...
    secondaryPropertyToSearch: "Director",
    jsonContainer: "Search",
    apiKey: "b56732e1",
	...
	// Formatters
    resultsFormatter: function(item){ return "<li>" + item[this.propertyToSearch]+ ": " + item[this.secondaryPropertyToSearch] + "</li>" },
...
$.TokenList = function (input, url_or_data, settings) {
    ...
    function populate_dropdown (query, results) {        
        if(results && results.length) {
            // console.log('populate_dropdown inside if1', results, results.length)
            dropdown.empty();
            var dropdown_ul = $("<ul>")
                .appendTo(dropdown)
                .mouseover(function (event) {
            ...
            $.each(results, function(index, value) {
                // console.log('populate_dropdown', index, value)
